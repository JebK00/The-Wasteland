...
def draw():
    if points_de_victoire==20:
        ...
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Little Fighter', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'A Hideo Kojima Game', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'A Wasteland Studio Game', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Produced and Realised by', 7)
        pyxel.text(0,74,'Hideo Kojima', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Lead Programming: Nils Doucet', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Artistical Direction: Renan Laugier', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Technical and Engine Programming: Lucas Lex', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Collision Programming: Joachim Andersen from Andersen System', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'From an idea of Lucas Lex, Renan Laugier, Nils Doucet and Hideo Kojima', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Thanks to Andersen System for technical help', 7)
        time.sleep(5)
        pyxel.cls(0)
        pyxel.text(0, 64, 'Copyright 2024 - France - Kojima Production - Wasteland Game', 7)
    else:
